...
def run_evaluation_00(experiment_name: str, run_name: str, checkpoint_name: str, log: bool, debug: bool = False):
    """
...
#####===== Main Functions =====#####
def run_evaluation(experiment_name: str, run_name: str, checkpoint_name: str, training_id: int, log: bool = False, debug: bool = False):
...
def main():
    ...
    if QUEUED:
        if len(EXPERIMENT_NAMES)==0:
            ...
            for i in range(len(EXPERIMENT_NAMES)):
                ...
                run_evaluation(exp_name, run_name, args.checkpoint, args.training_id, args.log, args.debug)
    # Run a single training for the run defined by the environment or passed as arguments
        ...
        run_evaluation(exp_name, run_name, args.checkpoint, args.evaluation_id, args.log, args.debug)
