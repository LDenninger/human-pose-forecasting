import torch
from data_utils import SkeletonModel32, H36MDataset, H36M_SKELETON_STRUCTURE, baseline_forward_kinematics, convert_baseline_representation
from visualization import visualize_skeleton
import time
...
def test_skeleton32_model():
    ...
    for seq, label in dataset:
        ...
        for i in range(seq.shape[0]):
            ...
            baseline_positions = baseline_forward_kinematics(angles=seq[i])
